...
<li>gam user (admin email) print filelist select id "folder ID" todrive (This will print out all the files in the shared drive and print them out to your personal drive)</li>
